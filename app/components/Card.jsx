...
export default function ScrollCards() {
  ...
  return (
    <section ref={containerRef} className="relative h-[500vh] md:h-[700vh] bg-white">
...
>
  <h2 className="text-[40px] md:text-[100px] font-black text-gray-800 text-center leading-[0.9] flex items-center justify-center">
    {card.title}
    <span className={`ml-2 mt-24 md:ml-2 rounded-full w-[20px] h-[20px] md:w-[40px] md:h-[40px] ${colorMap[card.bgColor]}`} />
  </h2>
</motion.div>

<motion.div
  className={`${card.bgColor} rounded-[20px]  md:rounded-[40px] p-6 md:p-12 border-2 md:border-4 border-white shadow-xl md:shadow-2xl`}
  style={{
    width: "90%",
    height: "auto",
    minHeight: "500px",
